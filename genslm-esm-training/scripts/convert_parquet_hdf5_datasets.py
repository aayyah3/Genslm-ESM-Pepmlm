...
train_path = [
    '/lus/eagle/projects/FoundEpidem/hippekp/genslm-foundation/data/ncbi/refseq.parsed/parquet-training/train_epoch_6_linclust50_faafna.parquet',
    '/lus/eagle/projects/FoundEpidem/hippekp/genslm-foundation/data/ncbi/refseq.parsed/parquet-training/train_epoch_7_linclust50_faafna.parquet',
    '/lus/eagle/projects/FoundEpidem/hippekp/genslm-foundation/data/ncbi/refseq.parsed/parquet-training/train_epoch_8_linclust50_faafna.parquet',
    '/lus/eagle/projects/FoundEpidem/hippekp/genslm-foundation/data/ncbi/refseq.parsed/parquet-training/train_epoch_9_linclust50_faafna.parquet',
]
...
tokenizer_path = (
    '/lus/eagle/projects/FoundEpidem/azton/genslm-esm/tokenizer_esm_genslm'
)
...
if False:
    for i, filename in tqdm(
        ...
        h5path = f'/lus/eagle/projects/FoundEpidem/azton/genomes/refseq_genslm_esm/test_{rootname}.h5'
...
if True:
    ...
    h5path = f'/lus/eagle/projects/FoundEpidem/azton/genomes/refseq_genslm_esm/valid{rootname}.h5'
    with h5py.File(h5path, 'w') as h5file:
        # h5file.create_dataset('id', data=ids, dtype=str_dtype)
        h5file.create_dataset('codon', data=codon_strs, dtype=str_dtype)
        h5file.create_dataset(
