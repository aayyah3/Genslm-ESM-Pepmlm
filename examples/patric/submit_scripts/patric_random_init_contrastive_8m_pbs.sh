...
accelerate_config_file=/lus/eagle/projects/CVD-Mol-AI/braceal/src/genslm-esm/examples/patric/deepspeed_configs/deepspeed_ddp_dynamo_single_node.yaml
...
config_file=/lus/eagle/projects/CVD-Mol-AI/braceal/src/genslm-esm/examples/patric/training_configs/patric_random_init_contrastive_8m.yaml
