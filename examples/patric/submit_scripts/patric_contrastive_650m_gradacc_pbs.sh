...
accelerate_config_file=/lus/eagle/projects/CVD-Mol-AI/braceal/src/genslm-esm/examples/patric/deepspeed_configs/deepspeed_ddp_dynamo_gradient_accumulation.yaml
...
config_file=/lus/eagle/projects/CVD-Mol-AI/braceal/src/genslm-esm/examples/patric/training_configs/patric_contrastive_650m_gradacc.yaml
